package thelm.packageddraconic.integration.appeng.tile;
...
public class AEMarkedInjectorTile extends MarkedInjectorTile implements IGridHost, IActionHost {

	public boolean firstTick = true;
	public BaseGridBlock<AEMarkedInjectorTile> gridBlock;
	public IActionSource source;
	public IGridNode gridNode;

	public AEMarkedInjectorTile() {
		super();
