...
public class FusionPackageRecipeType implements IPackageRecipeType {
	...
	public static final List<ResourceLocation> CATEGORIES = Collections.singletonList(new ResourceLocation("draconicevolution:fusion"));
	public static final Vector3i COLOR = new Vector3i(139, 139, 139);
	public static final Vector3i COLOR_CENTER = new Vector3i(179, 139, 179);
	...
	public IFormattableTextComponent getDisplayName() {
		return new TranslationTextComponent("recipe.packageddraconic.fusion");
	}

	@Override
	public IFormattableTextComponent getShortDisplayName() {
		return new TranslationTextComponent("recipe.packageddraconic.fusion.short");
	}
